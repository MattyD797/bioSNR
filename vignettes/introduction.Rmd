...
Frequency (pitch) is the number of sound waves or oscillations produced in one second represented by the unit Hertz (Hz). In reference to our hearing range, sound with a frequency below 20 Hz is *infrasound* and sound above 20000 Hz is *ultrasound*. 
...
The formula to find sound speed in the _ocean_:
